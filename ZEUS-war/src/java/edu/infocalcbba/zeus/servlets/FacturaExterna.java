 ...
 * @author tincho
 */
@WebServlet(name = "FacturaExterna", urlPatterns = {"/reportes/FacturaExterna"})
public class FacturaExterna extends HttpServlet {
    ...
    private static final int ALTO_MINIMO = 650;
    ...
    public void generarPDF(HttpServletRequest request, HttpServletResponse response) {
        ...
        String car_cap = (String) request.getSession().getAttribute("car_cap");
        String gru_cap = (String) request.getSession().getAttribute("gru_cap");
        String est_cap = (String) request.getSession().getAttribute("est_cap");
        Integer cel_cap = (Integer) request.getSession().getAttribute("cel_cap");
        ...
        if (id_factura != null) {
            ...
            try {
                ...
                document.add(titulo_factura(factura));
                ...
                document.add(titulo_comprobante(factura, est, car, car_cap, gru_cap, est_cap, cel_cap));
    ...
    public PdfPTable titulo_factura(Factura factura) {
        PdfPTable table = new PdfPTable(1);
    ...
    public PdfPTable titulo_comprobante(Factura factura, String estudiante, String carrera, String car_cap, String gru_cap, String est_cap, Integer cel_cap) {
        PdfPTable table = new PdfPTable(1);
        ...
        cell = new PdfPCell(new Phrase("Valorado: " + factura.getId_factura(), normal));
        cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
        cell.setBorder(Rectangle.NO_BORDER);
        table.addCell(cell);
        ...
        if ((estudiante == null && carrera == null) && (car_cap == null && gru_cap == null && est_cap == null && cel_cap == null)) {
            cell = new PdfPCell(new Phrase("Señor(es): " + factura.getCliente().getNombre_razonsocial(), normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.BOTTOM);
            cell.setBorderWidthBottom(0.8f);
            cell.setPaddingBottom(10);
            table.addCell(cell);
        } else if ((estudiante != null && carrera != null) && (car_cap == null && gru_cap == null && est_cap == null && cel_cap == null)) {
            cell = new PdfPCell(new Phrase("Señor(es): " + factura.getCliente().getNombre_razonsocial(), normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            table.addCell(cell);

            cell = new PdfPCell(new Phrase("Estudiante: " + estudiante, normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            table.addCell(cell);

            cell = new PdfPCell(new Phrase("Carrera: " + carrera, normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.BOTTOM);
            cell.setBorderWidthBottom(0.8f);
            cell.setPaddingBottom(10);
            ...
            cell = new PdfPCell(new Phrase("Carrera: " + car_cap, normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            table.addCell(cell);

            cell = new PdfPCell(new Phrase("Grupo: " + gru_cap, normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            table.addCell(cell);
            
            cell = new PdfPCell(new Phrase("Estudiante: " + est_cap, normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            table.addCell(cell);
            
            cell = new PdfPCell(new Phrase("Celular: " + cel_cap, normal));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(Rectangle.BOTTOM);
            cell.setBorderWidthBottom(0.8f);
            cell.setPaddingBottom(10);
